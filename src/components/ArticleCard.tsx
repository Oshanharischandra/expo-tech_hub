...
const ArticleCard: React.FC<ArticleCardProps> = ({ article, featured = false }) => {
  ...
  if (featured) {
    return (
      <GlowCard customSize glowColor="gold" className="rounded-xl overflow-hidden group">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="relative overflow-hidden rounded-xl bg-[#141414]/90 transition-all duration-300"
        >
  ...
  return (
    <GlowCard customSize glowColor="gold" className="rounded-xl overflow-hidden group">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="relative overflow-hidden bg-[#141414]/90 rounded-xl transition-all duration-300"
      >
